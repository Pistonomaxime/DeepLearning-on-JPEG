...
def Cinq_essaies_sans_BN(Nom_Retour_TMP, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde):
	"""
...
def Cinq_essaies_avec_BN(Nom_Retour_TMP, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde):
	"""
...
def Cinq_essaies_Keras(Nom_Retour_TMP, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde):
	"""
	Procède à 5 essaies sans BN.
	"""
	base_dir = '/home/pistono/Bureau/DeepLearning/Temporaire/Resultats'
...
# Nom_Resultats = 'Resultats_Cifar-10_{}.txt'.format(qualite)
...
# Cinq_essaies_sans_BN(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde)
...
for i in range(5):
	...
	Nom_Resultats = 'Resultats_Cifar-10_{}_2.txt'.format(qualite)

...
def Essaies_perso(Nom_Retour_TMP, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, i):
	"""
...
def Essaies_Fu_Gu(Nom_Retour_TMP, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, i):
	"""
	Procède à 5 essaies sans BN.
	"""
	base_dir = '/home/pistono/Bureau/DeepLearning/Temporaire/Resultats'
...
if (compteur_general in range(0,5)):
	...
	Essaies_perso(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
elif(compteur_general in range(5,10)):
	X_train_perso, X_test_perso = Renvoie_Image_LD(base_dir_train, base_dir_test)
	Nom_Retour = 'LD_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
	...
	#Entre_NB_et_Centre
	X_train_perso, X_test_perso = Renvoie_Image_NB(base_dir_train, base_dir_test, qualite)
	Nom_Retour = 'C_entre_NB_et_Centre_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
	...
	#Entre_Centre_et_DCT
	X_train_perso, X_test_perso = Renvoie_Image_Centre(base_dir_train, base_dir_test, qualite)
	Nom_Retour = 'C_entre_Centre_et_DCT_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)


	#Entre_DCT_et_Quantif
	# if (qualite != 100):
	#on peux l'enlever on le fait deux fois sinon ca Quantif = 
	...
	X_train_perso, X_test_perso = Renvoie_Image_DCT(base_dir_train, base_dir_test, qualite)
	Nom_Retour = 'C_entre_DCT_et_Quantif_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
	...
	X_train_perso, X_test_perso = Renvoie_Image_Quantif(base_dir_train, base_dir_test)
	Nom_Retour = 'C_entre_Quantif_et_ZigZag_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
...
# 	X_train_perso, X_test_perso = Renvoie_Image_ZigZag(base_dir_train, base_dir_test)
# 	Nom_Retour = 'C_entre_ZigZag_et_Prediction_Fu_Gu_{}'
# 	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
	...
	Nom_Retour = 'C_entre_Prediction_et_ZigZag_Perso_{}'
	Essaies_perso(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
elif(compteur_general in range(55,60)):
	X_train_perso, X_test_perso = Renvoie_Image_Pred(base_dir_train, base_dir_test)
	Nom_Retour = 'C_entre_Prediction_et_ZigZag_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
	...
	X_train_perso, X_test_perso = Renvoie_Image_ZigZag_Vrai(base_dir_train, base_dir_test)
	Nom_Retour = 'C_entre_ZigZag_et_Huffman_Fu_Gu_{}'
	Essaies_Fu_Gu(Nom_Retour, y_train, y_test, X_test_perso, X_train_perso, num_category, batch_size, num_epoch, Nom_Resultats, Nom_Sauvegarde, compteur_general)
